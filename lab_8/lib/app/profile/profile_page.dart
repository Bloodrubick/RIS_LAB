        ...
        child: Column(
          children: [
            ...
            ListTile(
               ...
               title: Text(context.loc.clearCache, style: fonts.regular16),
               onTap: () async {
                   await context.read<CurrencyRepository>().clearCache();
                   await context.read<NewsRepository>().clearCache();
                   ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text(context.loc.cacheCleared)));
               },
            ),
            ...
            FutureBuilder<DateTime?>(
                ...
                builder: (context, snapshot) {
                    ...
                    String text = context.loc.noData;
                    if (date != null) {
                    ...
                    return ListTile(
                       ...
                       title: Text(context.loc.lastUpdate, style: fonts.regular16),
