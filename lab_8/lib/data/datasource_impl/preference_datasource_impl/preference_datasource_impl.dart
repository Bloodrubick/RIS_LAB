...
abstract class _Keys {
  ...
  static const String dataSource = 'data_source_key';
}
...
class PreferenceDatasourceImpl implements PreferenceDatasource {
  ...
  @override
  String get selectedDataSource => _sharedPreferences.getString(_Keys.dataSource) ?? 'sqflite';

  @override
  void setSelectedDataSource(String source) => _sharedPreferences.setString(_Keys.dataSource, source);
}
