...
class SettingsRepositoryImpl implements SettingsRepository {
  ...
  final StreamController<String> _dataSourceController = StreamController.broadcast();
  ...
  Future<void> initAsyncData() async {
    ...
    _isAuth = isAuth;
    _dataSourceController.add(_datasource.selectedDataSource);
  }
  ...
  @override
  Stream<String> get dataSourceStream => _dataSourceController.stream;

  @override
  String get selectedDataSource => _datasource.selectedDataSource;

  @override
  void setSelectedDataSource(String source) {
      _datasource.setSelectedDataSource(source);
